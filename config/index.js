export const config = {
    ...
    CALLBACK_TEMPLATE_ID: "-YAiuKBigXh-qgdKWcxxWDfG3M7bBYcTuTYFpikzfVe8",
    ...
    FESTIVALS: [
      {"type": "生日", "name": "老婆", "year": "2023", "date": "03-11"},
      {"type": "节日", "name": "结婚纪念日", "year": "2026", "date": "11-11"}
    ],
    // 限制重要节日的展示条目, 需要填写数字; 
